...
## @param color
func draw_line_3d(a: Vector3, b: Vector3, color: Color, no_depth_test = true):
	var g = ImmediateGeometry.new()
	g.material_override = _get_line_material(no_depth_test)
...
func _get_line_material(flags_no_depth_test = false) -> SpatialMaterial:
	var mat : SpatialMaterial
	if len(_line_material_pool) == 0:
		mat = SpatialMaterial.new()
		mat.flags_unshaded = true
		mat.flags_no_depth_test = flags_no_depth_test
